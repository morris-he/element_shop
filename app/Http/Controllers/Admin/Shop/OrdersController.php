...
use App\Models\Shop\Order, App\Models\Shop\Express;
use Carbon;
...
class OrdersController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return ['success' => true, 'msg' => '查询成功', 'data' => compact('orders')];
    }
    ...
    public function show($id)
    {
        ...
        return ['success' => true, 'msg' => '查询成功', 'data' => compact('order', 'expresses')];
    }
