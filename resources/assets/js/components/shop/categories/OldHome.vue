                    ...
                    <el-table :data="props.row.children" style="width: 100%"
                        ...
                        <el-table-column label="缩略图" prop="image">
                            <template slot-scope="scope">
                                <img :src="scope.row.image==null?'':'http://images.canon4ever.com/'+scope.row.image"
                                     class="thumb">
                            </template>
                        </el-table-column>
                        ...
                        <el-table-column label="是否显示">
                            <template slot-scope="scope">
                                <i :class="scope.row.is_show | checkOrclose"
                                   @click="changeAttr(scope.row, 'is_show') "></i>
                            </template>
                        </el-table-column>
                        ...
                        <el-table-column label="操作">
                            <template slot-scope="scope">
                                ...
                                <el-button size="mini" type="danger"
                                           @click="handleDelete(scope.$index, scope.row,props.row.children)">
                                    删除
                                </el-button>
                            </template>
                        </el-table-column>
        ...
        methods: {
            ...
            showChildren() {
                if (this.expand.length != 0) {
                    ...
                    let ids =this.categories.map(category => {
